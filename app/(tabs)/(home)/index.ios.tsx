      ...
      {activeTab === 'tracking' ? (
        ...
        <View style={[styles.planningHeaderRow, { backgroundColor: isDark ? colors.backgroundDark : colors.background, borderBottomColor: isDark ? colors.borderDark : colors.border }]}>
          <TouchableOpacity
            ...
            onPress={() => {
              console.log('[Home iOS] Planning back button pressed — returning to Tracking');
          ...
          <View style={styles.planningTabsRow}>
            <TouchableOpacity
              ...
              onPress={() => {
                console.log('[Home iOS] Planning underline tab pressed: plans');
            ...
            <TouchableOpacity
              style={styles.planningTab}
              onPress={() => {
                console.log('[Home iOS] Planning underline tab pressed: recipes');
