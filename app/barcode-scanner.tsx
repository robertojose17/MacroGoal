...
function buildSyntheticOffData(item: any) {
    ...
    if (servingDesc && item.serving_size) {
      ...
      console.log('[BarcodeScanner] buildSyntheticOffData: totalGrams=', totalGrams, 'serving_size per unit=', item.serving_size, 'servingCount=', servingCount);
    ...
    console.log('[BarcodeScanner] buildSyntheticOffData: serving_description=', servingDesc, 'serving_count=', servingCount, 'serving_size=', servingSizeStr);
