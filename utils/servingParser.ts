...
// Re-export singularizeUnit from the dependency-free stringUtils module.
// This breaks the circular import chain that caused "undefined is not a function"
// in the production bundle: FoodDetailsLayout → openFoodFacts → servingParser (cycle).
export { singularizeUnit } from '@/utils/stringUtils';
